        ...
        try:
          ...
          #for line in stdout.readlines():
           # print (line.strip())
                ...
                file_failed.close()
                file_output.write("failediii: "+str(host_name+"\n"))
                file_output.close()
                #raise paramiko.ssh_exception.SSHException() from None
		#quit()
          ...
          #print ("might be windows but check------------")
          file_output.write("error check: "+str(host_name+"\n"))
          file_output.close()
          file_error.write(str(host_name + "\n"))
          file_error.close() 
